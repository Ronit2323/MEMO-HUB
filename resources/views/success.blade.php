...
<body>
    ...
    <div class="row justify-content-center mt-5">
        <h1 class="text-center mt-5">Payment Details of {{ Auth::user()->name }}</h1>
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">

                    <ul>
                        <li><strong>Transaction Code:</strong> {{ $paymentData['transaction_code'] }}</li>
                        <li><strong>Status:</strong> {{ $paymentData['status'] }}</li>
                        <li><strong>Total Amount:</strong> {{ $paymentData['total_amount'] }}</li>
                        <!-- Add more payment attributes as needed -->
                    </ul>
                </div>
